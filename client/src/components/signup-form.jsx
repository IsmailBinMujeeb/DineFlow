...
export function SignupForm({
    ...
    const [passwordMessage, setPasswordMessage] = useState('Must be at least 8 characters long.')
    ...
    const onSubmit = async (data) => {
        ...
        if (data.password !== data.confirmPassword) return setPasswordMessage('Password and confirm password must be same.');
        if (data.password.length < 8) return setPasswordMessage('Must be at least 8 characters long.');
            ...
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 md:grid-cols-2">
                    <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
                        <FieldGroup>
                            ...
                            <Field>
                                ...
                                <FieldDescription>
                                    We will use this for authentication. We will not share your
                    ...
                    <div className="bg-muted relative hidden md:block">
                        <img
                            src="https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2071"
                            alt="Image"
